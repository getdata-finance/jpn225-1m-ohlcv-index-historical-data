...
> **Sample on GitHub** · `JPN225_1m.csv` (55,440 rows, `2026-07-07` -> `2026-09-02`, 3.72 MB). **Full archive on [getdata.finance](https://getdata.finance/datasets/jpn225)** — **5,192,657** `1m` rows, **11 timeframes**, `2008-09-01` -> `2026-09-02`.
